...
class Multi_menu {
    ...
    public function renderId($config = array(), $divided_items_list = array(), $divider = '')
    {
		$html  = "";
    	...
    	if ( count($this->items) ) 
    	{
	        ...
	        $this->render_item_id($items, $html);
    	}
	...
	{	    
	    ...
	    foreach ($items as $item)
	    {
	        ...
	        {
		        $label = '<span class="text">'.$item[$this->menu_label].'</span>';
		        ...
		        if ($icon) 
		        {
		        	$icon = "<span class='icon'><i class='{$icon}'></i></span>";
	...
	private function render_item_id($items, &$html = '')
	{	    
	    if ( empty($html) ) 
	    {
	    	$nav_tag_opened = true;
	    ...
	    foreach ($items as $item)
	    {
	        ...
	        {
	        	$parentId = 'parent-id=""';
	        	if ($item[$this->menu_parent]) {
	        		$parentId = 'parent-id="'.$item[$this->menu_parent].'"';
	        	}
		        $label = '<span class="text" menu-id="'.$item[$this->menu_id].'" '.$parentId.'>'.$item[$this->menu_label].'</span>';
		        ...
		        if ( $has_children ) 
		        {	        	
		            $this->render_item_id($item['children'], $html);
