...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/fckeditor/ckfinder/ckfinder.js"></script>
  <style type="text/css">
...
(function()
{
    ...
    config.connectorPath = '<?php echo base_url('ckfinder/connector') ?>'
